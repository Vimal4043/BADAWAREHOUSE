...
export default function AboutValues() {
  return (
    <section
      ...
      className="scroll-mt-12 bg-[#0a192f] px-5 py-10 text-white md:px-10 md:py-12"
    >
      <div className="mx-auto w-full max-w-7xl px-5 sm:px-6 lg:px-8">
        <Reveal>
          <Overline light>Our Values</Overline>
          <h2 className="mt-6 max-w-6xl font-heading text-3xl font-extrabold leading-tight tracking-tight md:text-5xl">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <h4 className="font-heading text-xl font-bold">{v.title}</h4>
                </div>
